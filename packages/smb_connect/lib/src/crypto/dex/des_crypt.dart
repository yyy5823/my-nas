...
class DESCrypt implements BlockCipher {
  static final List<int> s0p = [
    0x00410100,
    0x00010000,
    0x40400000,
    0x40410100,
  ...
  static final List<int> permRight0 = [
    0x00000000,
    0x40000000,
    0x00400000,
    0x40400000,
  ...
  static final List<int> permLeft1 = [
    0x00000000,
    0x40000000,
    0x00400000,
    0x40400000,
  ...
  static final List<int> permRight2 = [
    0x00000000,
    0x10000000,
    0x00100000,
    0x10100000,
  ...
  static final List<int> permLeft3 = [
    0x00000000,
    0x10000000,
    0x00100000,
    0x10100000,
  ...
  static final List<int> permRight4 = [
    0x00000000,
    0x04000000,
    0x00040000,
    0x04040000,
  ...
  static final List<int> permLeft5 = [
    0x00000000,
    0x04000000,
    0x00040000,
    0x04040000,
  ...
  static final List<int> permRight6 = [
    0x00000000,
    0x01000000,
    0x00010000,
    0x01010000,
  ...
  static final List<int> permLeft7 = [
    0x00000000,
    0x01000000,
    0x00010000,
    0x01010000,
  ...
  static final List<int> permRight8 = [
    0x00000000,
    0x80000000,
    0x00800000,
    0x80800000,
  ...
  static final List<int> permLeft9 = [
    0x00000000,
    0x80000000,
    0x00800000,
    0x80800000,
  ...
  static final List<int> permRightA = [
    0x00000000,
    0x20000000,
    0x00200000,
    0x20200000,
  ...
  static final List<int> permLeftB = [
    0x00000000,
    0x20000000,
    0x00200000,
    0x20200000,
  ...
  static final List<int> permRightC = [
    0x00000000,
    0x08000000,
    0x00080000,
    0x08080000,
  ...
  static final List<int> permLeftD = [
    0x00000000,
    0x08000000,
    0x00080000,
    0x08080000,
  ...
  static final List<int> permRightE = [
    0x00000000,
    0x02000000,
    0x00020000,
    0x02020000,
  ...
  static final List<int> permLeftF = [
    0x00000000,
    0x02000000,
    0x00020000,
    0x02020000,
  ...
  ///
  ///        Initial Permutation
  static final List<int> initPermLeft0 = [
    0x00000000,
    0x00008000,
    0x00000000,
    0x00008000,
  ...
  static final List<int> initPermRight0 = [
    0x00000000,
    0x00000000,
    0x00008000,
    0x00008000,
  ...
  static final List<int> initPermLeft1 = [
    0x00000000,
    0x80000000,
    0x00000000,
    0x80000000,
  ...
  static final List<int> initPermRight1 = [
    0x00000000,
    0x00000000,
    0x80000000,
    0x80000000,
  ...
  static final List<int> initPermLeft2 = [
    0x00000000,
    0x00004000,
    0x00000000,
    0x00004000,
  ...
  static final List<int> initPermRight2 = [
    0x00000000,
    0x00000000,
    0x00004000,
    0x00004000,
  ...
  static final List<int> initPermLeft3 = [
    0x00000000,
    0x40000000,
    0x00000000,
    0x40000000,
  ...
  static final List<int> initPermRight3 = [
    0x00000000,
    0x00000000,
    0x40000000,
    0x40000000,
  ...
  static final List<int> initPermLeft4 = [
    0x00000000,
    0x00002000,
    0x00000000,
    0x00002000,
  ...
  static final List<int> initPermRight4 = [
    0x00000000,
    0x00000000,
    0x00002000,
    0x00002000,
  ...
  static final List<int> initPermLeft5 = [
    0x00000000,
    0x20000000,
    0x00000000,
    0x20000000,
  ...
  static final List<int> initPermRight5 = [
    0x00000000,
    0x00000000,
    0x20000000,
    0x20000000,
  ...
  static final List<int> initPermLeft6 = [
    0x00000000,
    0x00001000,
    0x00000000,
    0x00001000,
  ...
  static final List<int> initPermRight6 = [
    0x00000000,
    0x00000000,
    0x00001000,
    0x00001000,
  ...
  static final List<int> initPermLeft7 = [
    0x00000000,
    0x10000000,
    0x00000000,
    0x10000000,
  ...
  static final List<int> initPermRight7 = [
    0x00000000,
    0x00000000,
    0x10000000,
    0x10000000,
  ...
  static final List<int> initPermLeft8 = [
    0x00000000,
    0x00000800,
    0x00000000,
    0x00000800,
  ...
  static final List<int> initPermRight8 = [
    0x00000000,
    0x00000000,
    0x00000800,
    0x00000800,
  ...
  static final List<int> initPermLeft9 = [
    0x00000000,
    0x08000000,
    0x00000000,
    0x08000000,
  ...
  static final List<int> initPermRight9 = [
    0x00000000,
    0x00000000,
    0x08000000,
    0x08000000,
  ...
  static final List<int> initPermLeftA = [
    0x00000000,
    0x00000400,
    0x00000000,
    0x00000400,
  ...
  static final List<int> initPermRightA = [
    0x00000000,
    0x00000000,
    0x00000400,
    0x00000400,
  ...
  static final List<int> initPermLeftB = [
    0x00000000,
    0x04000000,
    0x00000000,
    0x04000000,
  ...
  static final List<int> initPermRightB = [
    0x00000000,
    0x00000000,
    0x04000000,
    0x04000000,
  ...
  static final List<int> initPermLeftC = [
    0x00000000,
    0x00000200,
    0x00000000,
    0x00000200,
  ...
  static final List<int> initPermRightC = [
    0x00000000,
    0x00000000,
    0x00000200,
    0x00000200,
  ...
  static final List<int> initPermLeftD = [
    0x00000000,
    0x02000000,
    0x00000000,
    0x02000000,
  ...
  static final List<int> initPermRightD = [
    0x00000000,
    0x00000000,
    0x02000000,
    0x02000000,
  ...
  static final List<int> initPermLeftE = [
    0x00000000,
    0x00000100,
    0x00000000,
    0x00000100,
  ...
  static final List<int> initPermRightE = [
    0x00000000,
    0x00000000,
    0x00000100,
    0x00000100,
  ...
  static final List<int> initPermLeftF = [
    0x00000000,
    0x01000000,
    0x00000000,
    0x01000000,
  ...
  static final List<int> initPermRightF = [
    0x00000000,
    0x00000000,
    0x01000000,
    0x01000000,
  ...
  @override
  int get blockSize => DES_BLOCK_SIZE;
  ...
  void init(bool forEncryption, CipherParameters? params) {
    ...
    if (params is KeyParameter) {
      // key = params.key;
      expandKey(params.key);
    } else {
      throw Exception("Required KeyParameter as params");
    }
  }

  @override
  Uint8List process(Uint8List data) {
    Uint8List out = Uint8List(blockSize);
    if (forEncryption) {
      encryptBlock(data, 0, out, 0);
    } else {
      decryptBlock(data, 0, out, 0);
    }
    return out;
  }
  ...
  void encryptBlock(
      Uint8List plain, int plainOffset, Uint8List cipher, int cipherOffset) {
    //, int plainOffset, byte[] cipher, int cipherOffset)
  ...
  /// @param plainOffset the offset in <code>plain</code>
  void decryptBlock(
      Uint8List cipher, int cipherOffset, Uint8List plain, int plainOffset) {
    cipherBlock(cipher, cipherOffset, plain, plainOffset);
  }

  void cipherBlock(Uint8List inp, int inpOffset, Uint8List out, int outOffset) {
    int temp;
    int i, j;
    int offset;
    int left, right;

    left = initialPermutationLeft(inp, inpOffset);
    right = initialPermutationRight(inp, inpOffset);
  ...
  static void perm(int left, int right, Uint8List out, int offset) {
    int low, high, temp;
    // Uint8List out = Uint8List(8);
    // int offset = 0;
  ...
  static int initialPermutationLeft(Uint8List block, int offset) {
    int l;
  ...
  static int initialPermutationRight(Uint8List block, int offset) {
    int l;
  ...
  void expandKey(Uint8List key) {
    int octet;
    Uint8List ek = Uint8List(128); //new byte[128];
